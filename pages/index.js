...
export default function Home() {
  return (
    <>
      ...
      {/* Hero Section */}
      <main className="pt-28 md:pt-32 bg-white dark:bg-slate-900 min-h-screen">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-12">
            ...
            <div className="flex-1">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <Link
                  href="/wish/new"
                  className="px-6 py-3 rounded-lg bg-[var(--color-primary)] text-white font-medium hover:bg-opacity-90 transition"
                >
                  Make a Wish
                </Link>
                <Link
                  href="/explore"
                  className="px-6 py-3 rounded-lg border border-[var(--color-primary)] text-[var(--color-primary)] font-medium hover:bg-[var(--color-primary)] hover:text-white transition"
                >
                  Browse Wishes
                </Link>
              </div>
            ...
            <div className="flex-1 bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-md border border-slate-100 dark:border-slate-700">
              <h4 className="text-[var(--color-primary)] font-semibold mb-2">Featured Wish</h4>
              ...
              <Link
                href="/explore"
                className="mt-4 inline-block px-5 py-2 rounded-lg bg-[var(--color-primary)] text-white hover:bg-opacity-90 transition"
              >
                View Wishes
              </Link>
            </div>
        ...
        <section className="container mx-auto px-6 py-20 grid md:grid-cols-3 gap-8">
          {[
            ...
            <div
              key={i}
              className="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-sm hover:shadow-lg border border-slate-100 dark:border-slate-700 transition-all duration-300"
            >
